    ...
    internal abstract class JVMGenerator : Generator {
        ...
        protected CodeMemberMethod CreateMethodSignature(GMethod method, bool skipSignature) {
            ...
            if (method.IsConstructor) {
                ...
                FixReturnType(method, tgtMethod);
            }
        ...
        private void FixReturnType(GMethod method, CodeMemberMethod tgtMethod) {
            switch (method.ReturnType.CLRReference.BaseType) {
                case "System.Collections.Generic.IDictionary`2":
                    tgtMethod.ReturnType = new CodeTypeReference("system.collections.IDictionary");
                    break;

                case "System.Collections.Generic.ISet`1":
                    tgtMethod.ReturnType = new CodeTypeReference("system.collections.IList");
                    break;
            }
        }
