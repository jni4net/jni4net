...
public class NullReferenceException extends system.SystemException {
    ...
    private native static void __ctorNullReferenceException0(net.sf.jni4net.inj.ICClrProxy thiz);
    
    @net.sf.jni4net.attributes.ClrMethod("(Ljava/lang/String;)V")
    private native static void __ctorNullReferenceException1(net.sf.jni4net.inj.ICClrProxy thiz, java.lang.String message);
    
    @net.sf.jni4net.attributes.ClrMethod("(Ljava/lang/String;Lsystem/Exception;)V")
    private native static void __ctorNullReferenceException2(net.sf.jni4net.inj.ICClrProxy thiz, java.lang.String message, system.Exception innerException);
