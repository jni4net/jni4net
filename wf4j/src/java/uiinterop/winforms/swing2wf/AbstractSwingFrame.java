...
*/
package uiinterop.winforms.swing2wf;
 ...
 * Time: 7:12:39 PM
 */
public abstract class AbstractSwingFrame<TFrame extends JFrame> extends AbstractAWTFrame<TFrame> {
    @Override
    public void setContentPane(Container contentPane) {
        getComponent().setContentPane(this.contentPane = contentPane);
    }

    @Override
    protected void tuneFrame(TFrame tFrame) {
    }
}
