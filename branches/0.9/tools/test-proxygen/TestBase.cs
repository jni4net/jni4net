...
namespace test.proxygen
{
    ...
    public abstract class TestBase
    {
        ...
        protected IKnownTypes KnownTypes;
        ...
        public void Init()
        {
            ...
            KnownTypes = Container.Resolve<IKnownTypes>();
        }
    }
}
...
namespace play
{
    ...
    {
        // <XX extends IEnumerable<T> & ICollection<Object> & IList<IEnumerable<Object>>> 
        private void getCurrent3<XX>(XX dfgdf)
            where XX : IEnumerable<T>, ICollection<Object>, IList<IEnumerable<Object>>
        {
        }
