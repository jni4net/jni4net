...
@net.sf.jni4net.attributes.J4NProxy(system.SByte.class)
@SuppressWarnings({"UnusedDeclaration", "NullableProblems", "RedundantCast", "deprecation", "unchecked"})
public final class SByte extends system.ValueType implements system.nongeneric.IComparable, system.IFormattable, system.IConvertible
// <j4ni-SByte>
...
// </j4ni-SByte>
{
    ...
    private SByte(long j4n_handle, net.sf.jni4net.core.ClrInstanceInfo j4n_instanceInfo) {
    ...
    static private class j4n_ProxyFactory implements net.sf.jni4net.core.IClrProxyFactory{
        ...
        public net.sf.jni4net.IClrProxy CreateInstance(long j4n_handle) {
            return new system.SByte(j4n_handle, (net.sf.jni4net.core.ClrInstanceInfo)null);
        }
    }
    ...
    static  {
        system.SByte.j4n_ProxyInit(null);
    }
    ...
    static public native boolean TryParse(java.lang.String s, net.sf.jni4net.Out<system.SByte> result);
    ...
    static public native boolean TryParse(java.lang.String s, system.Enum style, system.IFormatProvider provider, net.sf.jni4net.Out<system.SByte> result);
    
    /// <signature>#8 (Ljava/lang/Object;)I (Ljava/lang/Object;)I</signature>
    public native int CompareTo(java.lang.Object obj);
    
    /// <signature>#9 (B)I (B)I</signature>
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.SByte_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.SByte.class, system.SByte.class, system.SByte.class, new system.SByte.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
