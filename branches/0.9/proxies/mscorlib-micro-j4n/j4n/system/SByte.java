...
// </j4ni-SByte>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.SByte_, " + net.sf.jni4net.modules.mscorlibmicroj4n.assemblyName, system.SByte.class, system.SByte.class, system.SByte.class, new system.SByte.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
