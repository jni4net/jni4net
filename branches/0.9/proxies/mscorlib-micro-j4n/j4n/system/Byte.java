...
// </j4ni-Byte>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Byte_, " + net.sf.jni4net.modules.mscorlibmicroj4n.assemblyName, system.Byte.class, system.Byte.class, system.Byte.class, new system.Byte.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
