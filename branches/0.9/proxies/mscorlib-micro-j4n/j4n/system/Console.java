...
// </j4ni-Console>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Console_, " + net.sf.jni4net.modules.mscorlibmicroj4n.assemblyName, system.Console.class, system.Console.class, system.Console.class, new system.Console.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
