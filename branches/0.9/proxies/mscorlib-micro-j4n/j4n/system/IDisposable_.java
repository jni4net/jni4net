...
// </j4ni-IDisposable_>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.IDisposable_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.IDisposable.class, system.IDisposable_.class, system._IDisposable.class, new system.IDisposable_.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
