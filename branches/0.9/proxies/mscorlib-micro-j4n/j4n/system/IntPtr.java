...
// </j4ni-IntPtr>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.IntPtr_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.IntPtr.class, system.IntPtr.class, system.IntPtr.class, new system.IntPtr.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
