...
// </j4ni-MethodBase>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Reflection.MethodBase_, " + net.sf.jni4net.modules.mscorlibmicroj4n.assemblyName, system.reflection.MethodBase.class, system.reflection.MethodBase.class, system.reflection.MethodBase.class, new system.reflection.MethodBase.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
