...
// </j4ni-Assembly>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Reflection.Assembly_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.reflection.Assembly.class, system.reflection.Assembly.class, system.reflection.Assembly.class, new system.reflection.Assembly.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
