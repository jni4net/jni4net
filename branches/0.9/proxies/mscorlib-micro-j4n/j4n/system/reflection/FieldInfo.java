...
// </j4ni-FieldInfo>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Reflection.FieldInfo_, " + net.sf.jni4net.modules.mscorlibmicroj4n.assemblyName, system.reflection.FieldInfo.class, system.reflection.FieldInfo.class, system.reflection.FieldInfo.class, new system.reflection.FieldInfo.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
