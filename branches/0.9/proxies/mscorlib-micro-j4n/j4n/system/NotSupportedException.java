...
// </j4ni-NotSupportedException>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.NotSupportedException_, " + net.sf.jni4net.modules.mscorlibmicroj4n.assemblyName, system.NotSupportedException.class, system.NotSupportedException.class, system.NotSupportedException.class, new system.NotSupportedException.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
