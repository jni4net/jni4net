...
@net.sf.jni4net.attributes.J4NProxy(system.Int32.class)
@SuppressWarnings({"UnusedDeclaration", "NullableProblems", "RedundantCast", "deprecation", "unchecked"})
public final class Int32 extends system.ValueType implements system.nongeneric.IComparable, system.IFormattable, system.IConvertible
// <j4ni-Int32>
...
// </j4ni-Int32>
{
    ...
    public Int32(int value) {
        super(net.sf.jni4net.core.Registry.CreateBoxedInteger(value), (net.sf.jni4net.core.ClrInstanceInfo)null);
    }

    public int value() {
        return net.sf.jni4net.core.Registry.UnboxInteger(j4n_clrHandle);
    }
    // </j4nb-Int32>
    
    private Int32(long j4n_handle, net.sf.jni4net.core.ClrInstanceInfo j4n_instanceInfo) {
    ...
    static private class j4n_ProxyFactory implements net.sf.jni4net.core.IClrProxyFactory{
        ...
        public net.sf.jni4net.IClrProxy CreateInstance(long j4n_handle) {
            return new system.Int32(j4n_handle, (net.sf.jni4net.core.ClrInstanceInfo)null);
        }
    }
    ...
    static  {
        system.Int32.j4n_ProxyInit(null);
    }
    ...
    static public native boolean TryParse(java.lang.String s, net.sf.jni4net.Out<system.Int32> result);
    ...
    static public native boolean TryParse(java.lang.String s, system.Enum style, system.IFormatProvider provider, net.sf.jni4net.Out<system.Int32> result);
