...
// </j4ni-Flushable_>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "java.io.Flushable_, " + net.sf.jni4net.modules.jremicroj4n.assemblyName, java.io.Flushable.class, java_.io.Flushable_.class, java_.io._Flushable.class, new java_.io.Flushable_.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
