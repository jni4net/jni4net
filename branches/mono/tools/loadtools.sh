...
java -cp $dp0/loader Loader http://jni4net.googlecode.com/svn/tools/lib/ $dp0/lib/ ant.jar ant-launcher.jar jacobe.jar junit.jar classworlds-1.1.jar maven-2.0.9-uber.jar nunit.framework.dll
