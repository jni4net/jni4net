...
// </j4ni-SystemException>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.SystemException_, " + net.sf.jni4net.modules.mscorlibmicroj4n.assemblyName, system.SystemException.class, system.SystemException.class, system.SystemException.class, new system.SystemException.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
