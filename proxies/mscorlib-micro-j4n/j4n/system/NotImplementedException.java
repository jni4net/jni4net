...
// </j4ni-NotImplementedException>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.NotImplementedException_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.NotImplementedException.class, system.NotImplementedException.class, system.NotImplementedException.class, new system.NotImplementedException.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
