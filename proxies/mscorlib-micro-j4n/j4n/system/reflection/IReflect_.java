...
// </j4ni-IReflect_>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Reflection.IReflect_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.reflection.IReflect.class, system.reflection.IReflect_.class, system.reflection._IReflect.class, new system.reflection.IReflect_.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
