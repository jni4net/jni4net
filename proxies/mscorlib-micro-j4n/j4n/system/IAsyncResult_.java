...
// </j4ni-IAsyncResult_>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.IAsyncResult_, " + net.sf.jni4net.modules.mscorlibmicroj4n.assemblyName, system.IAsyncResult.class, system.IAsyncResult_.class, system._IAsyncResult.class, new system.IAsyncResult_.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
