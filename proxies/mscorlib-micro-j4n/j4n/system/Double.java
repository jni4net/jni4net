...
// </j4ni-Double>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Double_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.Double.class, system.Double.class, system.Double.class, new system.Double.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
