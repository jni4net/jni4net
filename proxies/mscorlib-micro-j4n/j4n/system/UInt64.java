...
@net.sf.jni4net.attributes.J4NProxy(system.UInt64.class)
@SuppressWarnings({"UnusedDeclaration", "NullableProblems", "RedundantCast", "deprecation", "unchecked"})
public final class UInt64 extends system.ValueType implements system.nongeneric.IComparable, system.IFormattable, system.IConvertible
// <j4ni-UInt64>
...
// </j4ni-UInt64>
{
    ...
    private UInt64(long j4n_handle, net.sf.jni4net.core.ClrInstanceInfo j4n_instanceInfo) {
    ...
    static private class j4n_ProxyFactory implements net.sf.jni4net.core.IClrProxyFactory{
        ...
        public net.sf.jni4net.IClrProxy CreateInstance(long j4n_handle) {
            return new system.UInt64(j4n_handle, (net.sf.jni4net.core.ClrInstanceInfo)null);
        }
    }
    ...
    static  {
        system.UInt64.j4n_ProxyInit(null);
    }
    ...
    static public native boolean TryParse(java.lang.String s, net.sf.jni4net.Out<system.UInt64> result);
    ...
    static public native boolean TryParse(java.lang.String s, system.Enum style, system.IFormatProvider provider, net.sf.jni4net.Out<system.UInt64> result);
    
    /// <signature>#8 (Ljava/lang/Object;)I (Ljava/lang/Object;)I</signature>
    public native int CompareTo(java.lang.Object value);
    
    /// <signature>#9 (J)I (J)I</signature>
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.UInt64_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.UInt64.class, system.UInt64.class, system.UInt64.class, new system.UInt64.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
