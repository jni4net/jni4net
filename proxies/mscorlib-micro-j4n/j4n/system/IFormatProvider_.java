...
// </j4ni-IFormatProvider_>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.IFormatProvider_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.IFormatProvider.class, system.IFormatProvider_.class, system._IFormatProvider.class, new system.IFormatProvider_.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
