...
@net.sf.jni4net.attributes.J4NProxy(system.Int16.class)
@SuppressWarnings({"UnusedDeclaration", "NullableProblems", "RedundantCast", "deprecation", "unchecked"})
public final class Int16 extends system.ValueType implements system.nongeneric.IComparable, system.IFormattable, system.IConvertible
// <j4ni-Int16>
...
// </j4ni-Int16>
{
    ...
    public Int16(short value) {
        super(net.sf.jni4net.core.Registry.CreateBoxedShort(value), (net.sf.jni4net.core.ClrInstanceInfo)null);
    }

    public short value() {
        return net.sf.jni4net.core.Registry.UnboxShort(j4n_clrHandle);
    }
    // </j4nb-Int16>
    
    private Int16(long j4n_handle, net.sf.jni4net.core.ClrInstanceInfo j4n_instanceInfo) {
    ...
    static private class j4n_ProxyFactory implements net.sf.jni4net.core.IClrProxyFactory{
        ...
        public net.sf.jni4net.IClrProxy CreateInstance(long j4n_handle) {
            return new system.Int16(j4n_handle, (net.sf.jni4net.core.ClrInstanceInfo)null);
        }
    }
    ...
    static  {
        system.Int16.j4n_ProxyInit(null);
    }
    ...
    static public native boolean TryParse(java.lang.String s, net.sf.jni4net.Out<system.Int16> result);
    ...
    static public native boolean TryParse(java.lang.String s, system.Enum style, system.IFormatProvider provider, net.sf.jni4net.Out<system.Int16> result);
    
    /// <signature>#8 (S)I (S)I</signature>
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Int16_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.Int16.class, system.Int16.class, system.Int16.class, new system.Int16.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
