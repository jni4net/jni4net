...
// </j4ni-UInt32>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.UInt32_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.UInt32.class, system.UInt32.class, system.UInt32.class, new system.UInt32.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
