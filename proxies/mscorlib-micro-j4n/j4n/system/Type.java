...
// </j4ni-Type>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Type_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.Type.class, system.Type.class, system.Type.class, new system.Type.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
