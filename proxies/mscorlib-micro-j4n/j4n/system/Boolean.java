...
// </j4ni-Boolean>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "System.Boolean_, " + net.sf.jni4net.modules.mscorlibmicroj4n.proxyAssemblyName, system.Boolean.class, system.Boolean.class, system.Boolean.class, new system.Boolean.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
