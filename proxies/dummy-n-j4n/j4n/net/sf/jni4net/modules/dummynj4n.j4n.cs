...
namespace net.sf.jni4net.modules
{
    public class dummynj4n
    {
        ...
        {
            if(!isModuleInitialized) lock(typeof(dummynj4n))
            {
                ...
                global::net.sf.jni4net.core.Registry.RegisterClrProxy(typeof(dummy.clr.Interfaces_.Buufararable_), typeof(dummy.clr.Interfaces.Buufararable), "dummy.clr.Interfaces$Buufararable");
                global::net.sf.jni4net.core.Registry.RegisterClrProxy(typeof(dummy.clr.Interfaces_.Fuu_), typeof(dummy.clr.Interfaces.Fuu), "dummy.clr.Interfaces$Fuu");
                global::net.sf.jni4net.core.Registry.RegisterClrProxy(typeof(dummy.clr.Interfaces_.Guu_), typeof(dummy.clr.Interfaces.Guu), "dummy.clr.Interfaces$Guu");
                global::net.sf.jni4net.core.Registry.RegisterClrProxy(typeof(dummy.clr.Interfaces_.Zuu_), typeof(dummy.clr.Interfaces.Zuu), "dummy.clr.Interfaces$Zuu");
                global::net.sf.jni4net.core.Registry.RegisterClrProxy(typeof(dummy.clr.Interfaces_.Rab_), typeof(dummy.clr.Interfaces.Rab), "dummy.clr.Interfaces$Rab");
                global::net.sf.jni4net.core.Registry.RegisterClrProxy(typeof(dummy.clr.Interfaces_.YourPublicY_), typeof(dummy.clr.Interfaces.YourPublicY), "dummy.clr.Interfaces$YourPublicY");
                global::net.sf.jni4net.core.Registry.RegisterClrProxy(typeof(dummy.clr.Interfaces_.YourPublicZ_), typeof(dummy.clr.Interfaces.YourPublicZ), "dummy.clr.Interfaces$YourPublicZ");
            }
        }
    }
}
