...
// </j4ni-ObjectInput_>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "java.io.ObjectInput_, " + net.sf.jni4net.modules.jremicroj4n.assemblyName, java.io.ObjectInput.class, java_.io.ObjectInput_.class, java_.io._ObjectInput.class, new java_.io.ObjectInput_.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
