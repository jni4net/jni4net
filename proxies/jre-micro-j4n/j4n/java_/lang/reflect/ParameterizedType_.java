...
// </j4ni-ParameterizedType_>
{
    ...
    static protected synchronized net.sf.jni4net.core.ProxyInfo j4n_ProxyInit(net.sf.jni4net.inj.INJEnv env) {
        ...
        {
            j4n_TypeInfo = net.sf.jni4net.core.Registry.registerProxy(env, "java.lang.reflect.ParameterizedType_, " + net.sf.jni4net.modules.jremicroj4n.assemblyName, java.lang.reflect.ParameterizedType.class, java_.lang.reflect.ParameterizedType_.class, java_.lang.reflect._ParameterizedType.class, new java_.lang.reflect.ParameterizedType_.j4n_ProxyFactory());
        }
        return j4n_TypeInfo;
    }
}
