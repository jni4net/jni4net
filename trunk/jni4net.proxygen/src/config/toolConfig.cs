...
namespace net.sf.jni4net.proxygen.config {
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://jni4net.sf.net/0.8.0.0/toolConfig.xsd")]
    [System.Xml.Serialization.XmlRootAttribute("jni4net-proxygen", Namespace="http://jni4net.sf.net/0.8.0.0/toolConfig.xsd", IsNullable=false)]
