...
namespace net.sf.jni4net
{
  public static partial class Bridge
  {
    ...
    [FileIOPermission(SecurityAction.Assert, Unrestricted = true)]
    public static void LoadAndRegisterAssemblyFromClassLoader(java.io.File assemblyFile, java.lang.ClassLoader classLoader)
    {
    ...
    private static void RegisterAssembly(Assembly assembly, java.lang.ClassLoader classLoader)
    {
